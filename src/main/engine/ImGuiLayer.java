...
public class ImGuiLayer {
	...
	public ImGuiLayer(long glfWindowV, PickingTexture pickingTexture) {
		this.glfwWindow = glfWindowV;
	...
	public void initImGui() {
	    ...
	    glfwSetScrollCallback(glfwWindow, (w, xOffset, yOffset) -> {
	        ...
	        if(!io.getWantCaptureMouse() || gameViewWindow.getWantCaptureMouse()) {
	        	...
	        	//stop scrolling if mouse offset didn't change/mouse wasn't scrolling anymore
	        	mouseListener.clear();
	        }
	    });
